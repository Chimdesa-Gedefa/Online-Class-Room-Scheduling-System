...
<ul class="nav nav-tabs"> 
  ...
  <li class="active"><a class="year_section" href="#"><font color="white"><i class=" icon-lock icon-small"></i></font><font color="orange">Year Section </a></font></li>
...
<hr>
 ...
 <form id="save_voter" class="form-horizontal" method="POST" action="search_year_section_result.php">	
   ...
   <select name="year_section" class="span333" required="required">
	...
	<?php $year_section_query=mysql_query("select * from schedule order by schedule_id ASC")or die(mysql_error());
