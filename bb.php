...
<ul class="nav nav-tabs"> 
  ...
  <li class="active"><a class="year_section" href="#"><font color="white"><i class=" icon-lock icon-small"></i></font><font color="white">baraafi daree </a></font></li>
   <li><a class="instractor" href="search_instractor_schedule1.php" ><font color="white"><i class="icon-pencil icon-small"></i></font><font color="white">barsiisaa</a></font></li>
   <li ><a class="room" href="search_room_schedule1.php"><font color="white"><i class="icon-home icon-small"></i> daree</font></a></li>
</ul>
