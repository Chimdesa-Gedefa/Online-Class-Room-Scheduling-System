...
<ul class="nav nav-tabs"> 
  ...
  <li ><a class="class_schedule.php" href="class_schedule.php"><font color="white"><i class=" icon-lock icon-small"></i></font><font color="orange">Year Section </a></font></li>
   <li class="active"><a class="instractor" href="#" ><font color="white"><i class="icon-pencil icon-small"></i></font><font color="orange">Instructor</a></font></li>
   <li ><a class="room" href="search_room_schedule.php"><font color="orange"><i class="icon-home icon-small"></i> Room</font></a></li>
      <li ><a class="room" href="search_Exam room_schedule.php"><font color="reed"><i class="icon-pencil icon-small"></i>Exam Room</font></a></li>
...
<div class="tab-pane active" id="instractor">
<div class="hero-unit-y">
<h2>Search Instructor Schedule</h2>
Please select data on each field to filter.

<hr>

<form id="save_voter" class="form-horizontal" method="POST" action="search_instractor_result.php">	
    <fieldset>
	</br>
    ...
    <div class="controls">
   <select name="instractor" class="span333">
	<option>--Select--</option>
		<?php $instractor_query=mysql_query("select * from schedule order by schedule_id ASC")or die(mysql_error());
while($instractor_row=mysql_fetch_array($instractor_query)){
	?>
	<font size="30"><option><?php echo $instractor_row['instractor']; ?></option></font>
	<?php } ?>
	</select>
    </div>
    </div>
...
<?php $acadamic_year_query=mysql_query("select * from instractor")or die(mysql_error());
